from models import SenderAgreementList,SenderAgreement, Base,engine,SessionLocal
import json
import hashlib
...
async def extraction_task(procedure_name: str,lock: asyncio.Lock):
    ...
    try:
        ...
        logger.info(f"📦 Found {total} SenderAgreementList items in the database.")
